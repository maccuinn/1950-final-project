...
<body>
    ...
    <main class="home-page">
        ...
        <section class="intro">
            <h2>Launch Your New Career</h2>
            <p>With Web Development And Design 2</p>

            <div class="skills">
                <h3>Hands On Learning of In Demand Skills</h3>
                <ul>
                    <li>HTML5</li>
                    <li>CSS3</li>
                    <li>Media Queries</li>
            ...
            <div class="secondary-nav">
                ...
                <ul>
                    <li><a href="#0"></a>Course Details</li>
                    <li><a href="#0"><Learning Outcomes/a></li>
                    <li><a href="#0"></a>Course Schedule</li>
                    <li><a href="#0"></a>Lessons</li>
                </ul>
                <h2>Registration Info</h2>
                <ul>
                    <li><a href="#0">Registration Info</a></li>
                    <li><a href="#0"></a>Talk With An Advisor</li>
